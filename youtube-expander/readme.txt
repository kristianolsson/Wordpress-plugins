...
Tags: youtube, expander
Tested up to: 3.1
Requires at least: 3.0
Stable tag: trunk

Scans posts for Youtube URLs and expands them to show a playable video at the end of the post. 
...
To install the Youtube Expander:

1. Upload 'youtube-expander.php' to '/wp-content/plugins/youtube-expander/'.
